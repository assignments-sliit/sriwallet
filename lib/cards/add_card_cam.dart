...
class AddNfcCardPage extends StatefulWidget {
  const AddNfcCardPage({Key? key}) : super(key: key);

  @override
  State<AddNfcCardPage> createState() => _AddNfcCardPageState();
}

class _AddNfcCardPageState extends State<AddNfcCardPage> {
